    ...
    return (
        <>
            <div className='flex mt-5 h-auto md:flex lg:px-20 gap-3 md:gap-10'>
                ...
                <div>
                    <p><span className='text-grey-500'>Name: </span>{props.name}</p>
                    <p><span className='text-grey-500'>Subject: </span>{props.subject}</p>
                    <p><span className='text-grey-500'>Position: </span>{props.position}</p>
                </div>
            </div>
